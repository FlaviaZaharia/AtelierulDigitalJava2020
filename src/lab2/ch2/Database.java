...
public class Database {
    public Studio[] setData() {
        Premiu oscar1990 = new Premiu("oscar", 1990);
        Premiu oscar2000 = new Premiu("oscar", 2000);
        Premiu oscar2010 = new Premiu("oscar", 2010);
        Premiu oscar2018 = new Premiu("oscar", 2018);

        Actor actorOscar1999 = new Actor("actor cu 2 oscaruri", 35, new Premiu[]{oscar1990, oscar2000});
        ...
        Film film1 = new Film(1990, "film cu actori oscar", new Actor[]{actorOscar1999, actorFaraPremii01});
        ...
        Film film4 = new Film(2018, "film cu actori oscar", new Actor[]{actorOscar2010, actorOscar2018, actorFaraPremii02});
